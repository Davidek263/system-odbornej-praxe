...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    Route::prefix('guarantor')->group(function () {
        ...
        // ✅ Export (CSV) - FE posiela body => POST je hlavný
        Route::post('/internships/export', [InternshipController::class, 'exportGuarantorInternships']);

        // (voliteľné) nechaj aj GET kvôli testu v browseri / spätná kompatibilita
        Route::get('/internships/export', [InternshipController::class, 'exportGuarantorInternships']);
