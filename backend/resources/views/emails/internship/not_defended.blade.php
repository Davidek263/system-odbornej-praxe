                    ...
                    <tr>
                        <td>
                            <div style="background-color: #F44336; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
                                <h1 style="margin: 0;">✗ Prax neobhájená</h1>
                            </div>

                            <div style="background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd;">
                                <p style="margin: 0 0 15px 0;">Dobrý deň {{ $student->first_name }},</p>

                                <div style="background-color: #ffebee; padding: 20px; margin: 15px 0; border-radius: 5px; text-align: center;">
                                    <h2 style="margin: 0; color: #F44336;">Vaša odborná prax nebola obhájená</h2>
                                    <p style="margin: 10px 0; font-size: 18px;">Odborná prax bola označená ako <strong>neobhájená</strong>.</p>
                                </div>
                                ...
                                <div style="background-color: white; padding: 15px; margin: 15px 0; border-left: 4px solid #F44336;">
                                    ...
                                    <p style="margin-bottom: 0;"><strong>Aktuálny stav:</strong> Neobhájená</p>
                                </div>

                                <p style="background-color: #fff3e0; padding: 15px; border-left: 4px solid #FF9800; margin: 15px 0;">
                                    <strong>⚠️ Akcia potrebná:</strong> Prosím, kontaktujte garanta odbornej praxe pre ďalšie informácie.
                                </p>
