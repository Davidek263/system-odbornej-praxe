...
<head>
    ...
    <title>Nový dokument nahraný</title>
</head>
                    ...
                    <tr>
                        <td>
                            <div style="background-color: #4CAF50; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
                                <h1 style="margin: 0;">📄 Nový dokument nahraný</h1>
                            </div>

                            <div style="background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd;">
                                <p style="margin: 0 0 15px 0;">Dobrý deň{{ $company ? ' ' . $company->contact_person_name : '' }},</p>

                                <p style="margin: 0 0 15px 0;">Študent <strong>{{ $student->first_name }} {{ $student->last_name }}</strong> nahral nový dokument.</p>

                                <div style="background-color: white; padding: 15px; margin: 15px 0; border-left: 4px solid #4CAF50;">
                                    <h3 style="margin-top: 0;">Detaily dokumentu:</h3>
                                    <ul style="margin: 10px 0 0 0; padding-left: 20px;">
                                        <li><strong>Názov dokumentu:</strong> {{ $document->document_name }}</li>
                                        <li><strong>Typ dokumentu:</strong> {{ $document->documentType->document_type_name }}</li>
                                        <li><strong>Dátum nahrania:</strong> {{ \Carbon\Carbon::parse($document->uploaded_at)->format('d.m.Y H:i') }}</li>
                                    </ul>
                                </div>
                                ...
                                <div style="background-color: white; padding: 15px; margin: 15px 0; border-left: 4px solid #4CAF50;">
                                    ...
                                    <ul style="margin: 10px 0 0 0; padding-left: 20px;">
                                        ...
                                        <li><strong>Firma:</strong> {{ $company->company_name ?? 'Neuvedená' }}</li>
