...
<head>
    ...
    <title>Výkaz hodín zamietnutý</title>
</head>
                    ...
                    <tr>
                        <td>
                            <div style="background-color: #F44336; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
                                <h1 style="margin: 0;">✗ Výkaz hodín zamietnutý</h1>
                            </div>

                            <div style="background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd;">
                                <p style="margin: 0 0 15px 0;">Dobrý deň {{ $student->first_name }},</p>

                                <p style="margin: 0 0 15px 0;">Oznamujeme Vám, že Váš výkaz hodín bol <strong>zamietnutý</strong>.</p>
                                ...
                                <div style="background-color: #fff3e0; padding: 15px; margin: 15px 0; border-radius: 5px; border-left: 4px solid #FF9800;">
                                    <p style="margin: 0;"><strong>⚠️ Akcia potrebná:</strong> Prosím, opravte výkaz hodín a znovu ho nahrajte do systému.</p>
                                </div>
